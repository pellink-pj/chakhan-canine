...
KR_POPULARITY = {
    # 1~10위: 국민 반려견
    "maltese":              (1,  "말티즈", "한국인이 가장 사랑하는 압도적인 1위 견종"),
    "poodle-toy":           (2,  "푸들 (토이)", "털 빠짐이 적고 영리해 꾸준한 인기"),
    "poodle-miniature":     (2,  "푸들 (미니어처)", "털 빠짐이 적고 영리해 꾸준한 인기"),
    "poodle-standard":      (2,  "푸들 (스탠다드)", "털 빠짐이 적고 영리해 꾸준한 인기"),
    # 3위 Mixed Breed: AKC 데이터 없음
    "pomeranian":           (4,  "포메라니안", None),
    "korean-jindo-dog":     (5,  "진돗개", "마당이 있는 단독주택 양육 비율 1위"),
    "shih-tzu":             (6,  "시츄", None),
    "bichon-frise":         (7,  "비숑 프리제", None),
    "chihuahua":            (8,  "치와와", None),
    "golden-retriever":     (9,  "골든 리트리버", "대형견 중 1위"),
